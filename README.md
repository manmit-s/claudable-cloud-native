...
> [!IMPORTANT]
> **Project Notice & Credits**
>
> This repository is a fork and extension of the excellent open-source project **[Claudable](https://github.com/opactorai/Claudable)** by **[opactorai](https://github.com/opactorai)**. All credits for the original Next.js codebase, desktop integration, and multi-CLI service architecture go to the original authors.
> 
> **Current Project Status**: 
> We are transforming this application into a fully **cloud-native, multi-user SaaS platform**. The entire Claude Code execution engine is being moved off the user's local machine and into isolated, server-side Docker container workspaces. Data persistence and user authentication are being migrated from local SQLite to **Supabase**.
